...
export default function PortoesSection() {
  return (
    <section className="bg-papel-2 px-6 py-16">
      <div className="mx-auto max-w-4xl">
        ...
        <div className="grid gap-6 sm:grid-cols-2">
          <Link href="/para-voce" className="group">
            <div className="flex h-full flex-col gap-4 rounded-2xl bg-white p-6 shadow-[var(--shadow-quintal)] transition-transform group-hover:-translate-y-1">
              <p className="text-sm font-semibold text-terracota">pra você</p>
              <h3 className="font-titulo text-xl font-extrabold text-tinta">
                Sua vida, mais leve
              </h3>
              ...
              <span className="mt-auto pt-2 text-sm font-semibold text-verde-escuro underline underline-offset-2 group-hover:no-underline">
                Ver como funciona →
              </span>
            </div>
          </Link>

          <Link href="/para-seu-negocio" className="group">
            <div className="flex h-full flex-col gap-4 rounded-2xl bg-verde-escuro p-6 text-papel shadow-[var(--shadow-quintal)] transition-transform group-hover:-translate-y-1">
              <p className="text-sm font-semibold text-amarelo">pro seu negócio</p>
              <h3 className="font-titulo text-xl font-extrabold text-papel">
              ...
              <span className="mt-auto pt-2 text-sm font-semibold text-amarelo underline underline-offset-2 group-hover:no-underline">
                Ver como funciona →
              </span>
            </div>
          </Link>
